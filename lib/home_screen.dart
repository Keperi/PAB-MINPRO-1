...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadSongs() async {
    ...
    final raw = prefs.getStringList('songs') ?? [];
    setState(() {
      _songs = raw.map((e) => Song.fromMap(jsonDecode(e))).toList();
    });
  }
  ...
  Future<void> _saveSongs() async {
    ...
    await prefs.setStringList(
      'songs',
      _songs.map((s) => jsonEncode(s.toMap())).toList(),
    );
  }
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            // Chevron — tap untuk ke halaman edit
            GestureDetector(
              onTap: onEdit,
